...
description: Modern frontend architecture patterns for Svelte, React, Next.js, and TypeScript. Use when building UI components, implementing frontend features, optimizing performance, or working with SPAs.
scope:
  languages: [typescript, javascript]
  frameworks: [svelte, react, nextjs, spa]
  platforms: [netlify, generic]
---

# Frontend Development Patterns

This skill provides comprehensive guidance for modern frontend development. 
**Note on Preferences:** We prefer — but are not limited to — **SPAs**, and **Svelte** with **Netlify**. While many examples below use React/Next.js patterns, the underlying architectural concepts (component composition, state management, optimization) apply universally to modern frontend frameworks.
